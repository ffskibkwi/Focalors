...
int main(int argc, char* argv[])
{
    ...
    std::cout << "  A5: " << case_param.lx5 << " x " << case_param.ly5 << " x " << case_param.lz5 << "\n";
    std::cout << "  A6: " << case_param.lx6 << " x " << case_param.ly6 << " x " << case_param.lz6 << "\n";
    std::cout << "  A7: " << case_param.lx7 << " x " << case_param.ly7 << " x " << case_param.lz7 << "\n";
    std::cout << "  A8: " << case_param.lx8 << " x " << case_param.ly8 << " x " << case_param.lz8 << "\n";
    std::cout << "  A9: " << case_param.lx9 << " x " << case_param.ly9 << " x " << case_param.lz9 << "\n";
    std::cout << "  A10: " << case_param.lx10 << " x " << case_param.ly10 << " x " << case_param.lz10 << "\n";
    ...
    std::cout << "      " << case_param.nx5 << "x" << case_param.ny5 << "x" << case_param.nz5 << " (A5)\n";
    std::cout << "      " << case_param.nx6 << "x" << case_param.ny6 << "x" << case_param.nz6 << " (A6)\n";
    std::cout << "      " << case_param.nx7 << "x" << case_param.ny7 << "x" << case_param.nz7 << " (A7)\n";
    std::cout << "      " << case_param.nx8 << "x" << case_param.ny8 << "x" << case_param.nz8 << " (A8)\n";
    std::cout << "      " << case_param.nx9 << "x" << case_param.ny9 << "x" << case_param.nz9 << " (A9)\n";
    std::cout << "      " << case_param.nx10 << "x" << case_param.ny10 << "x" << case_param.nz10 << " (A10)\n";
    ...
    Domain3DUniform A5(
        case_param.nx5, case_param.ny5, case_param.nz5, case_param.lx5, case_param.ly5, case_param.lz5, "A5");
    Domain3DUniform A6(
        case_param.nx6, case_param.ny6, case_param.nz6, case_param.lx6, case_param.ly6, case_param.lz6, "A6");
    Domain3DUniform A7(
        case_param.nx7, case_param.ny7, case_param.nz7, case_param.lx7, case_param.ly7, case_param.lz7, "A7");
    Domain3DUniform A8(
        case_param.nx8, case_param.ny8, case_param.nz8, case_param.lx8, case_param.ly8, case_param.lz8, "A8");
    Domain3DUniform A9(
        case_param.nx9, case_param.ny9, case_param.nz9, case_param.lx9, case_param.ly9, case_param.lz9, "A9");
    Domain3DUniform A10(
        case_param.nx10, case_param.ny10, case_param.nz10, case_param.lx10, case_param.ly10, case_param.lz10, "A10");
    ...
    field3 u_A1, u_A2, u_A3, u_A4, u_A5, u_A6, u_A7, u_A8, u_A9, u_A10;
    field3 v_A1, v_A2, v_A3, v_A4, v_A5, v_A6, v_A7, v_A8, v_A9, v_A10;
    field3 w_A1, w_A2, w_A3, w_A4, w_A5, w_A6, w_A7, w_A8, w_A9, w_A10;
    field3 p_A1, p_A2, p_A3, p_A4, p_A5, p_A6, p_A7, p_A8, p_A9, p_A10;
    field3 c_A1, c_A2, c_A3, c_A4, c_A5, c_A6, c_A7, c_A8, c_A9, c_A10;
    ...
    u.set_x_face_center_field(&A6, u_A6);
    u.set_x_face_center_field(&A7, u_A7);
    u.set_x_face_center_field(&A8, u_A8);
    u.set_x_face_center_field(&A9, u_A9);
    u.set_x_face_center_field(&A10, u_A10);
    ...
    v.set_y_face_center_field(&A6, v_A6);
    v.set_y_face_center_field(&A7, v_A7);
    v.set_y_face_center_field(&A8, v_A8);
    v.set_y_face_center_field(&A9, v_A9);
    v.set_y_face_center_field(&A10, v_A10);
    ...
    w.set_z_face_center_field(&A6, w_A6);
    w.set_z_face_center_field(&A7, w_A7);
    w.set_z_face_center_field(&A8, w_A8);
    w.set_z_face_center_field(&A9, w_A9);
    w.set_z_face_center_field(&A10, w_A10);
    ...
    std::vector<Domain3DUniform*> domains = {&A1, &A2, &A3, &A4, &A5, &A6, &A7, &A8, &A9, &A10};
    ...
    w.set_boundary_type(&A10, LocationType::YNegative, PDEBoundaryType::Neumann);
    ...
    add_random_number(w_A5, -0.01, 0.01, 42);
    add_random_number(w_A6, -0.01, 0.01, 42);
    add_random_number(w_A7, -0.01, 0.01, 42);
    add_random_number(w_A8, -0.01, 0.01, 42);
    add_random_number(w_A9, -0.01, 0.01, 42);
    add_random_number(w_A10, -0.01, 0.01, 42);
    ...
    auto calc_MI = [&](int j) {
        double c_mean = c_A10.mean_at_xz_plane(j);
        double sigma  = 0.0;
        OPENMP_PARALLEL_FOR(reduction(+ : sigma))
        for (int i = 0; i < case_param.nx10; i++)
            for (int k = 0; k < case_param.nz10; k++)
                sigma += (c_A10(i, j, k) - c_mean) * (c_A10(i, j, k) - c_mean);
        sigma = std::sqrt(sigma / (case_param.nx10 * case_param.nz10));
        return 1 - sigma / 0.5;
    };
