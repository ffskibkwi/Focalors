...
public:
    ...
    void read_paras() override
    {
        ...
        // Obstacle parameters
        IO::read_number(para_map, "circle_radius_ratio", circle_radius_ratio);
        IO::read_number(para_map, "circle_center_y_ratio", circle_center_y_ratio);
        ...
        circle_radius   = circle_radius_ratio * Height;
        ...
        circle_radius /= mixing_channel_hydraulic_diameter;
        circle_center_x /= mixing_channel_hydraulic_diameter;
        circle_center_y /= mixing_channel_hydraulic_diameter;
    }
    ...
    bool record_paras() override
    {
        ...
        paras_record.record("Height", Height)
            ...
            .record("Pe", Pe)
            .record("nr", nr)
            .record("circle_radius_ratio", circle_radius_ratio)
            .record("circle_center_y_ratio", circle_center_y_ratio)
            .record("circle_radius", circle_radius)
            .record("circle_center_x", circle_center_x)
            .record("circle_center_y", circle_center_y)
    ...
    // Obstacle parameters
    double circle_radius_ratio   = 1.0;
    double circle_center_y_ratio = 0.3;
...
int main(int argc, char* argv[])
{
    ...
    ScalarSolver2D        scalar_solver_c(&u, &v, &c, case_param.nr, c_scheme);
    ...
    IBVelocitySolver2D_Uhlmann ib_solver_vel(&u, &v, coord_map_raw);
    ib_solver_vel.set_parameters(coord_map.get_h(), case_param.hx);

    // Initialize IBM particle velocities to zero (solid circle)
