...
namespace
{
    ...
    constexpr bool   PHI_ALL_NEUMANN    = true;
 ...
 * Variant: all physical phi boundaries are zero-Neumann.
 */
int main(int argc, char* argv[])
{
    ...
    std::cout << "  phi_boundary_mode: " << (PHI_ALL_NEUMANN ? "all_neumann" : "mixed_opening_dirichlet") << std::endl;
    ...
    IO::write_csv(vorticity, nowtime_dir + "/final/vorticity_" + std::to_string(runtime_final_step));
